...
function remove_footer_admin () {
    echo '感谢选择 <a href="https://www.aiyunbox.com/" target="_blank" style="text-decoration:none">云端-aiyunbox.com</a> 为您设计！';
    }
...
<style type="text/css">
/*login*/
body.login{background:url(<?php bloginfo('template_directory'); ?>/assets/img/background.jpg);background-size:cover;background-repeat:no-repeat;background-position:center center;display:flex;align-items:center;justify-content:center;}
...
echo '<div class="nopic_des"><p>请前往 【WP后台】-【外观】-【自定义】-【云端综合设置】<br>对默认缩略图进行设置，此为必设选项。</p><a class="" href="'.get_option('home').'/wp-admin/customize.php">立即前往</a></div>';
}
}
